class Person {
  ...
  // por boa prática é bom usar o nome GET antes do nome
  // como é método privado o certo é chamar essa função
  // chama 1 método privado
  getWeight() {
    return this._weight;
  }
...
p1.name = 'Mariah';
console.log(p1.name); // Acesso direto a variável pública
